...
$number = $_POST['number'];
$error = "";
# set  variables factos and author
$factors = [];
$author = $_POST['author'];
...
if (empty($number)) {
    ...
    # call the function write into txt file
    writeEntry($number, $factors, $author);
}
?>
<!DOCTYPE html>
<html>
